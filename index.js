...
const CATEGORIES = ['character', 'relationship', 'event', 'item', 'location', 'plot', 'timeline'];
...
- Each fact: {"category": "<one of: character, relationship, event, item, location, plot, timeline>", "text": "<concise fact>", "source_index": <message_number>}
...
- Use "timeline" for day/date changes and time skips. Always pair the day with what is most significant at that moment — format: "Day N — [what changed or happened]". Never extract a bare date alone. Message #1 = Day 01 unless that message explicitly states otherwise. Each distinct day that introduces something notable should get its own timeline fact.
...
EXAMPLE OUTPUT:
[{"category":"character","text":"Luna has silver eyes and white hair","source_index":3},{"category":"location","text":"The story takes place in the city of Westmarch","source_index":7},{"category":"timeline","text":"Day 01 — Zuko and Petra meet for the first time","source_index":1},{"category":"timeline","text":"Day 23 — Zuko and Petra have started dating","source_index":201}]`;
}
...
RULES:
- Output ONLY a valid JSON array — no markdown, no commentary, no explanation
- Each fact: {"category": "<one of: character, relationship, event, item, location, plot, timeline>", "text": "<concise fact — raw, explicit, direct>", "source_index": <message_number>}
...
EXAMPLE OUTPUT:
[{"category":"character","text":"Luna is a shameless fucking exhibitionist with a massive size kink","source_index":3},{"category":"relationship","text":"Marcus dominates and fucks Luna hard — she begs to be called his slut and means it","source_index":7},{"category":"timeline","text":"Day 01 — Marcus and Luna meet and fuck for the first time","source_index":1},{"category":"timeline","text":"Day 07 — Marcus moves in with Luna","source_index":89}]`;
}
